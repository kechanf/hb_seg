...
# 使用示例
# ----------------------
cropped_mask_root = "/data2/kfchen/tracing_ws/soma_seg/mask"
cropped_img_root = "/data2/kfchen/tracing_ws/soma_seg/cropped_dataset/img"
cropped_mask_root = "/data2/kfchen/tracing_ws/soma_seg/cropped_dataset/mask"

img_file = "/data2/kfchen/tracing_ws/soma_seg/tif_image/P00120-T001-R001-S006-B1_0000.tif"
mask_file = "/data2/kfchen/tracing_ws/soma_seg/mask/P00120-T001-R001-S006-B1_0000.tif"
...
target_img_dir = "/data2/kfchen/nnUNet/nnUNet_raw/Dataset201_hb_soma/imagesTr"
target_mask_dir = "/data2/kfchen/nnUNet/nnUNet_raw/Dataset201_hb_soma/labelsTr"
file_number = 0
for i, (img_patch, mask_patch) in enumerate(zip(img_patches, mask_patches)):
    file_number += 1
...
CUDA_VISIBLE_DEVICES=0 nnUNetv2_train 201 3d_fullres 0 -num_gpus 1
CUDA_VISIBLE_DEVICES=0 nnUNetv2_predict -i /data2/kfchen/tracing_ws/soma_seg/tif_image -o /data2/kfchen/tracing_ws/soma_seg/tif_image -d 201 -c 3d_fullres -f 0
'''
